...
const bookData = [
  {
    ...
    category_id: 1,
    price: 15.99,
    image_url: 'http://tolkiengateway.net/w/images/thumb/4/44/J.R.R._Tolkien_-_The_Fellowship_of_the_Ring.jpg/180px-J.R.R._Tolkien_-_The_Fellowship_of_the_Ring.jpg' ,
    review: 'Incredible world building! I love this slow unveiling of history and present danger. I enjoyed the film, but the book is SO much better - you really get to know Middle Earth as well as the characters. Left me yearning for more... - JiriO'
  },
  {
    ...
    review: 'I just love this series. I have read the books 3 times and I watch the show on HBO. - pamkaye'
  },
  {
    ...
    category_id: 1,
    price: 24.29,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/81iqZ2HHD-L.jpg',
    review: 'Wont say anything more, it is the best book ever in my opinion. Read the whole series! 10/10 recommend - @nOnymOus'
  },
  {
    book_name: 'The Lion, the Witch and the Wardrobe',
    author_name: 'C.S. Lewis',
    description: 'The full-color jacket features art by three-time Caldecott Medal-winning illustrator David Wiesner. The interior includes gorgeous black-and-white illustrations by Pauline Baynes, the original illustrator of Narnia. Four adventurous siblings—Peter, Susan, Edmund, and Lucy Pevensie—step through a wardrobe door and into the land of Narnia, a land frozen in eternal winter and enslaved by the power of the White Witch. But when almost all hope is lost, the return of the Great Lion, Aslan, signals a great change . . . and a great sacrifice.Journey into the land beyond the wardrobe! The Lion, the Witch and the Wardrobe is the second book in the C. S. Lewis classic fantasy series, which has been captivating readers of all ages for over sixty years. This is a stand-alone novel, but if you would like journey back to Narnia, read The Horse and His Boy, the third book in The Chronicles of Narnia.',  
    category_id: 1,
    price: 8.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/51erHMLhIzL.jpg',
    review: 'I grew up reading this book as a child & had misplaced that copy. I still had the rest of the books for the Chronicles series. I did not want my kids to miss out on this beloved book, so I bought it! My son finished reading it within 2-3 day- he loved that much! - Reebok10'
  },
  {
    book_name: 'The Eye of the World',
    author_name: 'Robert Jordan',
    description: 'The Eye of the World, the first novel in Robert Jordans #1 New York Times bestselling epic fantasy series, The Wheel of Time®, follows Moiraine Damodred as she arrives in Emonds Field on a quest to find the one prophesized to stand against The Dark One.',  
    category_id: 1,
    price: 35.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/913FyPpDusL.jpg',
    review: 'It is really the best epic fantasy. I finally started reading it. - Rhete Sch'
  },
  {
    book_name: 'Dune',
    author_name: 'Frank Herbert',
    description: 'Dune, Frank Herberts epic science-fiction masterpiece set in the far future amidst a sprawling feudal interstellar society, tells the story of Paul Atreides as he and his family accept control of the desert planet Arrakis. A stunning blend of adventure and mysticism, environmentalism, and politics, Dune is a powerful, fantastical tale that takes an unprecedented look into our universe, and is transformed by the graphic novel format. Brian Herbert and Kevin J. Anderson’s adaptation retains the integrity of the original novel, and Raúl Allén and Patricia Martín’s magnificent illustrations, along with cover art by Bill Sienkiewicz, bring the book to life for a new generation of readers. A national bestseller, Dune: The Graphic Novel, is now available in a deluxe collectors edition with an increased trim size of 7 1/2" x 11 1/4", printed on high-quality matte art paper in a faux-cloth slipcase with gold foil stamping tip-on cover.',  
    category_id: 2,
    price: 41.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/81ym3QUd3KL.jpg',
  ...
  },
  {
    ...
    category_id: 2,
    price: 19.49,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/51sdWhtHOwL.jpg',
    review: 'Read this book four times and will never get tired of reading it! - justalexiaaa'
  },
  {
  ...
  },
  {
    ...
    category_id: 3,
    price: 24.99,
    image_url:'https://www.pluggedin.com/wp-content/uploads/2020/01/gone-girl-cover.jpg',
  ...
  },
  {
    ...
    category_id: 3,
    price: 15.00,
    image_url:'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1282407491l/1870095.jpg',
    review: 'An interesting plot with interesting twists and turns. If its your first mystery book, be sure to give it a try. - bookNerd35'
  },
  {
  ...
  },
  {
    ...
    category_id: 5,
    price: 22.49,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/81qW97ndkvL.jpg',
    review: 'I love this book! It really opened my eyes up to a lot of lessons both in work life and personal life. MUST READ!!!!!!!!! - janjam56'
  },
  {
    book_name: 'Outliers',
    ...
    category_id: 5,
    price: 26.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/71PP92fxyEL.jpg',
    review: 'Insightful, a book anyone can take a lesson or two from. - OutTheDoor'
  },
  {
    ...
    category_id: 5,
    price: 22.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/615xhgxzDSL.jpg',
    review: 'I love this book. I am getting four more to share with family. -rainMan35'
  },
  {
    book_name: 'The Secret',
    author_name: 'Rhonda Byrne',
    description: 'The worldwide bestselling phenomenon that has helped millions tap the power of the law that governs all our lives to create—intentionally and effortlessly—a joyful life.',  
    category_id: 5,
    price: 15.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/81MArWaiw1L.jpg',
  ...
  },
  {
    ...
    category_id: 5,
    price: 24.99,
    image_url:'https://images-na.ssl-images-amazon.com/images/I/51cQEdN9KuL._SX331_BO1,204,203,200_.jpg',
    review: 'Could not put this translation down. Made me think and was not verbose. I plan on re-reading soon. - ATXHailey'
  },
];
